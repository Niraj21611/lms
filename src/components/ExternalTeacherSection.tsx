      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          {[
            ...
            <motion.div
              key={index}
              className={`group relative bg-white rounded-2xl p-8 border-2 ${benefit.borderColor} hover:shadow-2xl transition-all duration-300 overflow-hidden`}
            ...
            >
              ...
              <motion.div
                className={`absolute -top-10 -right-10 w-32 h-32 ${benefit.accentBg} rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                animate={{
                  scale: [1, 1.2, 1],
                }}
                transition={{
              ...
              <motion.div
                className={`relative z-10 w-14 h-14 rounded-xl ${benefit.bgColor} flex items-center justify-center text-white mb-4 shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}
              ...
              <motion.div
                className={`absolute bottom-0 right-0 w-16 h-16 ${benefit.accentBg} rounded-tl-full`}
                initial={{ scale: 0 }}
                whileInView={{ scale: 1 }}
                viewport={{ once: true }}
